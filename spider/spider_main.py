       ...
       # try:
        ...
        while urls.has_new_url() and self._running and outout<2:
            ...
            try:
                ...
                print(f"Thread:{self.name} id:{len(urls.old_urls)} URL:{urllib.parse.unquote(new_url).replace('https://baike.baidu.com/item/%E4%B8%8A%E6%B5%B7%E5%A4%A7%E5%AD%A6','')} {str(cost)[:4]}:sec/page")
...
if __name__=='__main__':
    ...
    PATH='urls.pkl'
    root_url = 'https://baike.baidu.com/item/%E4%B8%8A%E6%B5%B7%E5%A4%A7%E5%AD%A6'
    LOCK=threading.Lock()
